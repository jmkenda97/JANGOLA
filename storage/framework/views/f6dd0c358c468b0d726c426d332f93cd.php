<header class="navbar">
    <div class="container navbar-content">
      ...
      <div class="navbar-auth">
        <a href="<?php echo e(route('car.create')); ?>" class="btn btn-add-new-car">
        ...
        <a href="<?php echo e(route('signup')); ?>" class="btn btn-primary btn-signup">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <a href="<?php echo e(route('login')); ?>" class="btn btn-login flex items-center">
          <svg
  ...
  </header><?php /**PATH C:\Users\JACKSON MKENDA\JANGOLA\resources\views/components/layouts/header.blade.php ENDPATH**/ ?>